...
The frequency-change overlay used a separate draw and hit-test path with no direction gate.
It therefore left the ring shown and selectable after the route waypoint was hidden.
...
The supplied LLHZ loop also reproduces the independent SFAIM frequency-ring leak.
