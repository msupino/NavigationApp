...
// 'tel' rather than type="number", which would add spinner arrows to an identifier and is
// entitled to normalise away a leading zero.
...
test('a licence with a leading zero survives being typed', async ({ page }) => {
  ...
  expect(await page.inputValue('#fpl-license')).toBe('0451');
});
