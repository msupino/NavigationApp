...
window.S = {
  ...
  // --- יומן ניווט -------------------------------------------------------------
  tbNavTable: 'טבלת ניווט',
  tbNavTableTitle: 'טבלת הניווט: ממהירות מצוינת ועד כיוון מצפני, קטע אחר קטע',
  navTableTitle: 'טבלת ניווט',
  navLogHeaders: ['קטע', 'ממקום', 'למקום', 'מ.א.מ', 'גובה לחץ', 'טמפ', 'מ.א.א', 'כיוון רוח',
    'עוצמת רוח', 'נתיב אמיתי', 'סחיפה', 'כיוון אמיתי', 'נטייה', 'כיוון מגנטי', 'סטייה',
    'כיוון מצפני', 'מ/ק', 'מרחק', 'זמן', 'זמן מצטבר', 'תצרוכת', 'דלק נצרך', 'דלק מצטבר'],
  navLogCruiseAlt: 'גובה שיוט (רגל)',
