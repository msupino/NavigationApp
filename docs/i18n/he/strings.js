...
window.S = {
  ...
  primary: 'ראשי',
  commFail: 'כשל קשר',
  commFailTitle: 'אבדן קשר: מסלול לשדה הקרוב עם נוהל כשל קשר מפורסם',
  commFailHeading: 'כשל קשר',
  ...
  commFailReplace: 'להחליף את המסלול שלך במסלול כשל קשר ל-{field}? ביטול מחזיר את המסלול.',
  commFailReplaceOk: 'נווט לשם',
  commFailOther: 'שדות אחרים',
  commFailNoData: 'לא ניתן לטעון את נהלי כשל הקשר.',
