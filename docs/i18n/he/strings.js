...
window.S = {
  ...
  tbSimIpTitle: 'כתובת גשר SimConnect. חיבור HTTP פועל במחשב המקומי או כאשר גם דף NavAid נטען דרך HTTP; אחרת נדרש HTTPS.',
  ...
  tbSimHelpNative: 'יישומון מקומי: גרסה זו טוענת את אתר HTTPS. השתמשו בגשר HTTPS; חיבור HTTP מקומי דורש תמיכת רשת מקומית ביישומון.',
  ...
  tbSimNativeHttp: '⚠ גרסת היישומון הזו עדיין אינה יכולה להשתמש בגשר HTTP מקומי. הזינו כתובת HTTPS של גשר או מנהרה.',
