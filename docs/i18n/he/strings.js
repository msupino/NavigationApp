...
window.S = {
  ...
  inspTurnPin: '↻ קבעו נקודה זו כנקודת החזרה',
  inspTurnPinTitle: 'שומר על הנקודה הזו כנקודת החזרה גם אם המסלול ייערך בהמשך כך שאף קטע אינו חוזר על עצמו.',
  inspTurnIsAuto: '↻ נקודת חזרה — המסלול חוזר על עצמו כאן, ולכן זו הנקודה שבה הוא פונה הביתה.',
  inspTurnIsManual: '↻ נקודת חזרה — סימנתם את הנקודה הזו כמקום שבו המסלול פונה הביתה.',
