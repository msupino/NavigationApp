...
window.S = {
  ...
  fplAdvReset: '↻ שחזור ברירות מחדל',
  fplAdvResetTip: 'החזרת קטגוריית המערבולת, הציוד ואותיות המשדר לערכים התקניים של מטוס קל (L, S, C), והגשה לכתובת המפורסמת לסוג הטיסה הזה.',
  fplDate: 'תאריך הטיסה',
