...
window.S = {
  ...
  offlineCvfrProgress: function(p) { return 'CVFR לא מקוון: ' + p + '%'; },
  offlineCvfrWaiting: function(p) { return 'CVFR לא מקוון: ' + p + '% — ממתין לחיבור'; },
  offlineCvfrDetail: function(present, total, p) { return present + ' מתוך ' + total + ' אריחים · ' + p + '%'; },
  offlineCvfrRepair: 'תיקון אריחים חסרים',
