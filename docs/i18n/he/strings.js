...
window.S = {
  ...
  tbLegDirTitle: 'אילו חצי קטעים לצייר. במסלול הלוך-חזור שני הכיוונים נופלים זה על זה ליד נקודת החזרה — קריא על המסך, בלתי שמיש במפה מודפסת. קו המסלול עצמו לעולם אינו מוסתר, רק החצים.',
