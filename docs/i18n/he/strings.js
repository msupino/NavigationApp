...
window.S = {
  ...
  tbShowAirspace: 'הצג מרחב אווירי (P / R / TMA)',
  tbShowAirspaceTitle: 'אזורים אסורים ומוגבלים ומגזרי ה-TMA של נתב״ג, מתוך ה-AIP (ENR 5.1 ו-ENR 2.1), על גבולות הגובה שלהם. מצוירים מתחת למסלול: הגבול הוא אופקי בלבד, ולכן קטע שחוצה אזור עשוי עדיין להיות מעליו או מתחתיו — קראו את גבולות הגובה לפני הקו.',
