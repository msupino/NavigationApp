...
window.S = {
  ...
  tbSigwxTitle: 'הצג את מפות מזג האוויר המשמעותי (SIGWX) לפי זמן תוקף',
  ...
  routeCheckCouldNotAsk: 'לא נבדק (אין נתונים):',
  routeCheckNothing: 'אין',
  routeCheckNotRead: 'לא ניתן לקריאה',
  routeCheckFound: (n) => 'נמצאו ' + n,
  routeCheckSrcAirspace: 'מרחב אווירי',
  ...
  routeCheckNoAlt: 'נחצה, ולא תוכנן גובה לקטע הזה',
  routeCheckCeiling: 'בסיס עננים',
  routeCheckLayer: 'שכבה',
  routeCheckForecast: 'תחזית',
  routeCheckObserved: 'דווח',
  routeCheckLowestLeg: 'הקטע הנמוך שתוכנן',
  routeCheckFrom: 'מ-',
  routeCheckUntil: 'עד',
  routeCheckSfc: 'פני הקרקע',
  routeCheckUnl: 'ללא הגבלה',
  ...
  routeLibraryGroupTracks: 'הקלטות',
  routeLibraryShowLabel: 'הצג',
  routeLibraryShowAll: 'הכול',
  routeLibraryNoRoutes: 'אין עדיין מסלולים שמורים.',
  routeLibraryNoTracks: 'אין עדיין הקלטות.',
  routeLibraryProfileTitle: 'גובה ומהירות מתוכננת לאורך המסלול השמור, בלי לטעון אותו',
  routeProfileNothing: 'אין מספיק מסלול כדי לצייר פרופיל.',
  ...
  routeProfileExpand: '⤢',
  routeProfileExpandTitle: 'פתיחת הפרופיל בגדול',
  profileLegendAlt: 'גובה',
  profileLegendPlannedSpeed: 'מהירות מתוכננת',
  profileLegendGs: 'מהירות קרקע',
  profileLegendFlown: 'בפועל',
  profileLegendPlanned: 'מתוכנן',
  trackProfileCompareWith: 'השוו עם',
  trackProfileCompareNone: '— כלום —',
  trackProfileCompareMap: 'המסלול שעל המפה',
  profileLegendTerrain: 'תבליט',
  profileLegendMsa: 'גובה בטוח',
  ...
  primary: 'ראשי',
  commFail: 'תקלת קשר',
  commFailTitle: 'תקלת קשר: מסלול לשדה הקרוב עם נוהל תקלת קשר מפורסם',
  commFailHeading: 'תקלת קשר',
  commFailSquawk: 'סקווק',
  commFailVia: 'דרך',
  commFailAt: 'בגובה',
  commFailCallTower: 'אם יש לך טלפון, התקשר למגדל',
  commFailFromGps: 'ממיקום ה-GPS שלך',
  commFailFromMap: 'ממרכז המפה — אין קליטת GPS',
  commFailReplace: 'להחליף את המסלול שלך במסלול תקלת קשר ל-{field}? ביטול מחזיר את המסלול.',
  commFailReplaceOk: 'נווט לשם',
  commFailOther: 'שדות אחרים',
  commFailNoData: 'לא ניתן לטעון את נהלי תקלת הקשר.',
  commFailFromAreas: '{alt} רגל מאזורי אימון {areas}',
  commFailCancel: 'בטל תקלת קשר',
  commFailCancelTitle: 'החזר את המסלול והמפות שהיו לפני כן',
  commFailCancelKept: 'תקלת הקשר בוטלה. המסלול נערך מאז, לכן הוא נשאר.',
  commFailWaiting: 'ממתין למיקום ה-GPS שלך…',
  commFailUseMapCentre: 'השתמש במרכז המפה',
  commFailInArea: 'אתה באזור אימון {area}',
  commFailLights: 'אותות אור מהמגדל',
  commFailLightGreenName: 'ירוק רציף',
  commFailLightGreen: 'מותר לנחות',
  commFailLightGreenFlashName: 'ירוק מהבהב',
  commFailLightGreenFlash: 'חזור לנחיתה',
  commFailLightRedName: 'אדום רציף',
  commFailLightRed: 'תן זכות קדימה והמשך להקיף',
  commFailLightRedFlashName: 'אדום מהבהב',
  commFailLightRedFlash: 'השדה אינו בטוח — אל תנחת',
  commFailLightWhiteFlashName: 'לבן מהבהב',
  commFailLightWhiteFlash: 'נחת בשדה זה והמשך לרחבה',
  commFailLightFlareName: 'זיקוק אדום',
  ...
  // --- יומן ניווט -------------------------------------------------------------
  tbNavTable: '📐 טופס תכנון טיסה',
  tbNavTableTitle: 'טופס תכנון הטיסה: ממהירות מצוינת ועד כיוון מצפני, קטע אחר קטע',
  navTableTitle: 'טופס תכנון טיסה',
  // In the order the exercise sheet prints them.
  navLogHeaders: ['LEG', 'ממקום', 'למקום', 'מ.א.מ', 'גובה לחץ', 'טמפ', 'מ.א.א', 'רוח עוצמה',
    'רוח כיוון', 'נתיב אמיתי', 'סחיפה', 'כיוון אמיתי', 'נטייה מגנטית', 'כיוון מגנטי',
    'סטייה מצפנית', 'כיוון מצפני', 'מ/ק', 'מרחק', 'זמן', 'זמן מצטבר', 'תצרוכת דלק',
    'דלק נצרך', 'דלק מצטבר'],
  navLogHeaderTitles: ['קטע', 'ממקום', 'למקום', 'מהירות אוויר מכוילת', 'גובה לחץ',
    'טמפרטורת האוויר החיצוני', 'מהירות אוויר אמיתית', 'עוצמת הרוח', 'כיוון הרוח', 'נתיב אמיתי',
    'זווית סחיפה', 'כיוון אמיתי', 'נטייה מגנטית', 'כיוון מגנטי', 'סטייה מצפנית', 'כיוון מצפני',
    'מהירות קרקע', 'מרחק', 'זמן הקטע', 'זמן מההמראה', 'תצרוכת דלק לשעה', 'דלק לקטע',
    'דלק מההמראה'],
  ...
  navLogClimbPa: 'נתוני נסיקה ב-(%)',
  navLogDescentPa: 'נתוני הנמכה ב-(%)',
  navLogUseDefaultFraction: 'חזרה לשבר התקני',
  navLogClimbRate: 'שיעור נסיקה (רגל/דקה)',
  navLogDescentRate: 'שיעור הנמכה (רגל/דקה)',
  navLogClimbFuel: 'דלק בנסיקה (גלון)',
  navLogCruiseGph: 'תצרוכת בשיוט (גלון/שעה)',
  navLogMet: 'נתונים מטאורולוגיים',
  navLogMetAlt: 'גובה (רגל)',
  navLogMetDir: 'כיוון רוח',
  ...
  navTableReplaceRouteOk: 'טען את המסלול',
  navLogCsv: 'CSV',
  navLogPrint: 'הדפסה',
  navLogNoRate: 'אין שיעור',
  navLogNoteNoRate: 'לא הוזן שיעור נסיקה: אי אפשר לחשב את השורה הראשונה.',
  navLogNoteUnflyable: 'רוח צידית במסלול חזקה מהמהירות שטסים נגדה.',
  navLogNoteClipped: 'ההנמכה אינה נכנסת במסלול: המטוס מגיע מעל גובה השדה.',
  navLogUnflyable: 'אין פתרון',
  navLogFromTable: 'מהטבלה שהוקלדה',
  navLogFromApp: 'מרוח המסלול שבאפליקציה',
  navLogFromIsa: 'אטמוספירה תקנית — לא הוקלד ולא נמשך דבר',
  navLogNoRoute: 'שרטטו מסלול של שתי נקודות לפחות, וקבעו גובה שיוט מעל שני השדות.',
  ...
  tbAirfieldWind: 'הצג רוח בשדות',
  tbAirfieldWindTitle: 'נוצת רוח על פני הקרקע בכל שדה תעופה, לפי זמן ההסתכלות קדימה שלמעלה',
  afWindLoading: 'טוען רוח בשדות…',
  afWindErr: 'רוח בשדות אינה זמינה',
  afWindCalmLabel: 'רגוע',
  afWindRunwayLabel: 'רוח על המסלול',
  afWindHead: 'חזיתית',
  afWindTail: 'גבית',
  afWindCross: 'צד',
  afWindKt: 'קשר',
  ...
  deckHereTitle: 'מה יש כאן',
  deckHereCoords: 'מיקום',
  deckHereNearest: 'השדה הקרוב',
  deckHereTerrain: 'התבליט הגבוה',
  deckHereNow: 'עכשיו',
  ...
  layerLabels: { 'CVFR': 'CVFR', 'Navigation': 'ניווט', 'Low Alt': 'גובה נמוך',
                 ...
                 'OpenFlightMaps': 'OpenFlightMaps', 'World': 'עולם (לא מקוון)', 'ATS': 'נתיבי ATS' },
  layerNoDataOverIsrael: 'אין נתונים מעל ישראל: OpenFlightMaps מכסה כעשרים אזורים, רובם באירופה. הזיזו את המפה לשם כדי להשתמש בה.',
  ...
  tbLayerLabel: 'שכבה',
  tbMagVarLabel: 'סטייה מגנטית',
  tbMagVarTitle: 'אוטומטי: המודל המגנטי העולמי במיקום המטוס, אחרת במסלול, אחרת במרכז המפה (עובד גם ללא חיבור). ידני: הערך שלכם.',
  tbMagVarAuto: 'אוטומטי',
  tbMagVarManual: 'ידני',
  tbMagVarManualTitle: 'הסטייה שלכם, במעלות מזרח או מערב. בשימוש כשנבחר ידני.',
  ...
  tbFollowMeNewLink: '🔑 קישור חדש',
  tbFollowMeNewLinkTitle: 'לזרוק את קישור המעקב של המכשיר ולהתחיל חדש. מי שמחזיק בקישור הישן מאבד אותו.',
  followMeNewLinkConfirm: 'להתחיל קישור מעקב חדש?\n\nהקישור שהמכשיר שיתף עד עכשיו יפסיק לעבוד לכל מי שמחזיק בו, כולל מי שהתכוונתם להשאיר.',
  followMeNewLinkDone: 'קישור מעקב חדש — הישן מת.',
  followMeNewLinkBurned: 'הקישור הזה מת. בפעם הבאה שתשתפו ייווצר קישור חדש.',
  followMeNewLinkFailed: 'לא ניתן היה להתחיל קישור חדש במכשיר הזה.',
  followMeAskTitle: 'עקבו אחריי',
  followMeAskLabel: 'מזהה',
  followMeAskShare: 'שיתוף',
  followMeAskCode: 'מזהה, לדוגמא קוד מטוס (4X-CDE)\n\nהשירות משתמש בממסר ציבורי ללא הבטחת זמינות. כל מי שמחזיק בקישור יכול לצפות במיקומים או לשלוח מיקומים.',
  followMeNeedCode: 'למעקב דרוש מזהה — מי שפותח את הקישור צריך לדעת אחרי מה הוא עוקב.',
  ...
  followMeRouteLoaded: 'המסלול נטען מהטייס שאחריו עוקבים.',
  followMeStoppedLocal: 'השיתוף הופסק בטלפון הזה — הממסר לא ענה. אם הקישור עדיין אצל מישהו, השתמשו ב\u0022קישור חדש\u0022.',
  ...
  tbInspectorTracking: 'חלונית בזמן הצגת מיקום',
  tbInspectorTrackingTitle: 'לאפשר לנגיעה לפתוח את החלונית בזמן שהמיקום מוצג. כבוי כברירת מחדל: בטיסה המפה היא מה שקוראים.',
  inspectorTrackingBlocked: 'החלונית נשארת סגורה בזמן שהמיקום מוצג — אפשר להפעיל בתצוגה/הגדרה.',
  ...
  plateOpen: 'פתח',
  plateDownload: 'הורד',
  saveShareTitle: 'שמירה או שליחה',
  errSaveFailed: 'לא ניתן היה לשמור את הקובץ.',
  errSaveNeedsAppUpdate: 'שמירת קבצים דורשת גרסה חדשה יותר של אפליקציית NavAid. עדכנו אותה, או ייצאו מהאתר.',
  zoomIn: 'הגדל',
  ...
  densityAltitudeTitle: 'הגובה שהמטוס ״חושב״ שהשדה נמצא בו, אחרי חישוב הטמפרטורה וה-QNH. אוויר דליל מאריך את ריצת ההמראה ומשטיח את הטיפוס: כשגובה הצפיפות גבוה בהרבה מגובה השדה, הנתונים שבספר כבר אינם הנתונים. הזיזו את השעון שעל המפה כדי למצוא שעה שאפשר להמריא בה.',
  ...
  offlineManagerOnlineOnly: 'זמינות בחיבור בלבד: לוויין ו־OpenStreetMap. הספקים שלהן אינם מתירים להוריד אותן לשימוש לא מקוון.',
  offlineManagerMore: 'מפות נוספות, כמה שתרצו:',
  offlinePackDownload: '⬇ הורדה',
  offlinePackDownloadTitle: function(n) { return 'שמירת ' + n + ' במכשיר לשימוש לא מקוון'; },
  offlinePackRepair: '⬇ הורדת האריחים החסרים',
  offlinePackDelete: 'מחיקה',
  offlinePackDeleteTitle: function(n) { return 'הסרת ' + n + ' מהמכשיר'; },
  offlinePackDeleteConfirm: function(n) { return 'להסיר את ' + n + ' מהמכשיר?'; },
  offlinePackTiles: function(n) { return n.toLocaleString('en-US') + ' אריחים'; },
  offlinePackOneImage: 'תמונה אחת',
  offlineAreaName: function(lat, lng) { return 'אזור סביב ' + lat + ', ' + lng; },
  offlineAreaDownload: function(n) { return '⬇ הורדת האזור שעל המסך (' + n.toLocaleString('en-US') + ' אריחים)'; },
  offlineAreaDownloadTitle: 'שמירת המפה לאזור שהמפה מציגה עכשיו',
  offlineAreaDetail: 'רמת פירוט',
  offlineAreaLevel: function(z, n, size) { return 'עד תקריב ' + z + ' · ' + n.toLocaleString('en-US') + ' אריחים · ≈ ' + size; },
  offlineAreaTooBig: function(n, max) { return n.toLocaleString('en-US') + ' אריחים על המסך: יש להתקרב לפחות מ־' + max.toLocaleString('en-US') + '.'; },
  offlineAreaDeleteConfirm: 'להסיר את האזור הזה מהמכשיר?',
  offlineAreaCovered: 'האזור הזה כבר הורד.',
  offlinePackChecking: 'בודק…',
  offlinePackStarting: 'מתחיל הורדה…',
  ...
  inspTimerStart: '\u23f1 להתחיל את השעון כאן',
  inspTimerClear: '\u23f1 לספור שוב מההמראה',
  inspTimerStartTitle: 'לספור את הזמנים המצטברים מהנקודה הזו במקום משדה היציאה',
  inspTimerIsHere: '\u23f1 הזמנים המצטברים נספרים מכאן, במפה ובטופס תכנון הטיסה.',
  ...
  tbViewSource: 'GitHub',
  tbWiki: 'Wiki',
  disclaimerTitle: 'לפני הטיסה',
  disclaimerLead: 'NavAid הוא כלי תכנון בלבד. הוא אינו מאושר לניווט, ואין להשתמש בו כמקור מידע ראשי בטיסה.',
  disclaimerPointOfficial: 'תכננו וטוסו לפי תרשימים רשמיים ועדכניים, AIP, הודעות NOTAM ומזג אוויר.',
  disclaimerPointData: 'נתוני התרשימים, המרחב האווירי, ה\u0022נוטמים\u0022 ומזג האוויר כאן עלולים להיות חלקיים, מאוחרים או שגויים.',
  disclaimerPointPic: 'האחריות לניהול בטוח של הטיסה מוטלת על הטייס המפקד.',
  disclaimerAnalytics: 'האתר הזה משתמש ב-Google Analytics כדי לספור ביקורים אנונימיים, והוא מציב עוגיות של Google. המסלולים, המיקומים ותוכניות הטיסה שלך לעולם אינם נשלחים אליו.',
  disclaimerAccept: 'הבנתי',
  tbPrivacy: 'פרטיות',
  tbTerms: 'תנאי שימוש',
