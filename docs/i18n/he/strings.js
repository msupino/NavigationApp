...
window.S = {
  ...
  hideLegKite: '⊘ הסתר עפיפון',                   // כפתור בחלונית הקטע — הסתרת עפיפון הקטע
  showLegKite: '◉ הצג עפיפון',
  hideLegKiteTitle: 'הסתרת עפיפון הכיוון / הזמן / הגובה של הקטע, בשני הכיוונים. הקטע, שאר הסמנים ותכנית הטיסה אינם משתנים — לחצו על קו הקטע כדי להחזיר את העפיפון.',
  showLegKiteTitle: 'ציור עפיפון הכיוון / הזמן / הגובה של הקטע מחדש',
