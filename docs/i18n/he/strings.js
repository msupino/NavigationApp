...
window.S = {
  ...
  altPairsPair: 'נתיב',
  altPairsDirection: 'כיוון',
  altPairsAltitude: 'גובה',
  altPairsInbound: 'הלוך',
  altPairsOutbound: 'חזור',
  altPairsInboundTitle: 'גובה עבור הכיוון הראשון שמוצג בשורה',
  altPairsOutboundTitle: 'גובה עבור הכיוון ההפוך שמוצג בשורה',
  altPairsStatus: 'סוג',
