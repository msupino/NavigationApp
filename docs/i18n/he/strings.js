...
window.S = {
  ...
  tbShowMsa: 'תבליט + גובה בטוח',
  tbShowMsaTitle: 'צובע את המפה לפי גובה הקרקע, ומציג לכל קטע את הגובה הבטוח המינימלי בחלונית. אמצעי תכנון בלבד.',
  report: 'דיווח',
  ...
  followLockOff: 'המפה נשארת במקומה — הקישו כדי לעקוב אחרי המטוס',
