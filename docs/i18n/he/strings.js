...
window.S = {
  ...
  tbPlateAirfieldTitle: 'בחרו אילו שדות יציגו תרשימים, כדי ששדות שכנים לא יחפפו',
  tbPlateAirfieldAll: 'כל השדות',
  tbPlateAuto: 'אוטומטי (תחילת וסוף מסלול)',
  tbPlateAutoTitle: 'הצג תרשימים רק לשדה הראשון והאחרון במסלול; מתעדכן עם עריכת המסלול',
  tbPlateAll: 'הכול',
  tbPlateAllTitle: 'הצג את התרשימים של כל השדות; בטלו סימון לבחירת שדות מסוימים',
