...
window.S = {
  ...
  tbLegDir: '🧭 חצי הקטעים',
  tbLegDirTitle: 'אילו חצי קטעים לצייר. במסלול הלוך-חזור שני הכיוונים נופלים זה על זה ליד נקודת הסיבוב — קריא על המסך, בלתי שמיש במפה מודפסת. קו המסלול עצמו לעולם אינו מוסתר, רק החצים.',
  tbLegDirBoth: 'שני הכיוונים',
  tbLegDirOut: 'הלוך בלבד',
  tbLegDirBack: 'חזור בלבד',
  tbLegDirNoTurn: 'המסלול הזה אינו חוזר על עקבותיו ולא סומנה נקודת סיבוב, ולכן אין הלוך וחזור להפריד ביניהם. סמנו נקודת סיבוב על נקודת ציון כדי לאפשר זאת.',
  inspTurnSet: '\u21bb סימון כנקודת סיבוב',
  inspTurnClear: '\u21bb ביטול נקודת הסיבוב',
