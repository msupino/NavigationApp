...
window.S = {
  ...
  tbShowTrafficTitle: 'מטוסים שנשמעים ב-ADS-B, מצוירים כל עוד מיקום חי מוביל את המפה. כבוי במפת תכנון: תעבורה שאינכם טסים בתוכה היא קישוט, והבקשה עולה בסוללה. החץ מצביע לכיוון התנועה, ולצדו הקריאה והגובה במאות רגל.',
