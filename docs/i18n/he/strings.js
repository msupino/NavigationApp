...
window.S = {
  ...
  navTableFetchMetTitle: 'רוח וטמפרטורה לכל גובה שהטיסה עוברת בו, באמצע המסלול',
  navTableFetchMetErr: 'לא ניתן היה למשוך את התחזית.',
  navTableMetFetched: (n) => 'נמשכו ' + n + ' גבהים לטבלה.',
  ...
  navLogCsv: 'CSV',
  navLogPrint: 'הדפסה',
  navLogUnflyable: 'הרוח הצידית גדולה מהמהירות',
