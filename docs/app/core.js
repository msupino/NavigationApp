...
window.S = Object.assign({
  ...
  tbSimHelpNative: 'Native app: enter the simulator computer’s HTTP or HTTPS LAN address. localhost means this device.',
  tbSimHelpNativeOther: 'Native app: use an HTTPS bridge or tunnel. Local HTTP transport is available only in the iOS build.',
