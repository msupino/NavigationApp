...
NavAid.tuningGroups = [
  ...
  { name: 'Search', keys: ['searchMaxResults', 'searchMaxVor', 'searchMaxAirfields', 'searchMaxNavWp', 'searchMaxRouteWp', 'searchMaxNotes', 'searchNoteLabelChars'] },
...
window.S = Object.assign({
  ...
  fplKind: 'Flight type',
  fplKindRoutes: 'Along published routes (AIS)',
  fplKindCross: 'Cross-country (FPL desk)',
  fplReg: 'Call sign',
  fplRegHint: 'Three letters is enough — 4X is added',
  fplType: 'Aircraft type',
  fplWake: 'Wake category',
  fplEquip: 'Equipment',
  fplSurv: 'Transponder',
  ...
  fplSpeedRow: function(kt) { return 'Cruise ' + kt + ' kt (first leg)'; },
  ...
  errFplDepNotAerodrome: 'The first waypoint is not an aerodrome, so it cannot be the departure field.',
  ...
  errFplLatinOnly: 'Write the pilot name and licence in Latin letters — the flight-plan message cannot carry Hebrew.',
