...
window.S = Object.assign({
  ...
  tbLegArrowColorTitle: 'Fill colour of the leg arrows — applies to print/export too',
  tbWaypointColor: 'Waypoint color',
  tbWaypointColorTitle: 'Fill colour of the waypoint discs and their label backgrounds — applies to print/export too',
