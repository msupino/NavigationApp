...
NavAid.tuningDefaults = {
  ...
  // Inside a control zone the questions are close-in ones, so the band is tighter and deeper.
  followZoomCtrFloor: { value: 12, min: 6, max: 18, step: 0.5, label: 'Follow aircraft in a CTR: closest zoom to keep' },
  followZoomCtrCeiling: { value: 15, min: 6, max: 18, step: 0.5, label: 'Follow aircraft in a CTR: widest zoom to keep' },
  ...
  originResnapArmPx: { value: 18, min: 2, max: 60, step: 1, label: 'Drag distance before the first waypoint re-snaps (px)' },
  ...
  satellitePreviewZoom: { value: 16, min: 10, max: 19, step: 1, label: 'Satellite zoom in the small preview' },
  ...
  vorRangeRingDashPx: { value: 7, min: 0, max: 30, step: 1, label: 'VOR range ring dash length (px)' },
  vorRangeRingGapPx: { value: 6, min: 0, max: 30, step: 1, label: 'VOR range ring dash gap (px)' },
  ...
  vorRangeRingLabelGapPx: { value: 3, min: 0, max: 20, step: 1, label: 'VOR range ring label gap (px)' },
  ...
  overlayLabelHaloWidthPx: { value: 2.5, min: 0, max: 10, step: 0.5, label: 'Overlay label halo width (px)' },
  liveHeadingTickHaloColor: { value: '#000000', type: 'color', label: 'Heading tick label halo color' },
  liveHeadingTickHaloAlpha: { value: 0.8, min: 0, max: 1, step: 0.05, label: 'Heading tick label halo opacity (0-1)' },
  liveHeadingTickHaloWidthPx: { value: 3, min: 0, max: 10, step: 0.5, label: 'Heading tick label halo width (px)' },
  ...
  notamBadgeFontPx: { value: 11, min: 6, max: 24, step: 1, label: 'NOTAM badge font size (px)' },
  ...
  driftDashOnPx: { value: 12, min: 1, max: 60, step: 1, label: 'Drift line dash length (px)' },
  driftDashOffPx: { value: 8, min: 0, max: 60, step: 1, label: 'Drift line dash gap (px)' },
  driftStrokeWidthPx: { value: 1.5, min: 0.25, max: 8, step: 0.25, label: 'Drift line thickness (px)' },
  ...
  defaultLabelMarginPx: { value: 20, min: 0, max: 120, step: 1, label: 'Marker label margin, scaled with the leg label box (px)' },
  defaultKiteHalfWidthPx: { value: 23, min: 1, max: 80, step: 1, label: 'Leg label box half-width (px)' },

  legKiteFillColor: { value: '#00ff00', type: 'color', label: 'Leg label box fill color' },
  returnKiteFillColor: { value: '#ffccd6', type: 'color', label: 'Return-leg label box fill color' },
  legKiteHeightPx: { value: 47, min: 8, max: 120, step: 1, label: 'Leg label box height (px)' },
  legKiteCellWidthPx: { value: 24, min: 8, max: 80, step: 1, label: 'Leg label box column width (px)' },
  legKiteTriangleLenPx: { value: 35, min: 8, max: 100, step: 1, label: 'Leg label box pointer length (px)' },
  ...
  kitePrintHeightMm: { value: 18.5, min: 2, max: 120, step: 0.5, label: 'Leg label box height on paper (mm)' },
  legKiteBorderPx: { value: 2, min: 0.25, max: 8, step: 0.25, label: 'Leg label box border width (px)' },
  legKiteDividerPx: { value: 1, min: 0.25, max: 6, step: 0.25, label: 'Leg label box column divider width (px)' },
  legKiteHaloPx: { value: 7, min: 0, max: 20, step: 0.5, label: 'Leg label box halo width (px)' },
  legKiteTextPx: { value: 13, min: 4, max: 36, step: 1, label: 'Leg label box text size (px)' },
  legKiteHeadingTextPx: { value: 13, min: 4, max: 40, step: 1, label: 'Leg label box heading text size (px)' },
  legKiteHeadingAnchor: { value: 0.25, min: -0.5, max: 1, step: 0.01, label: 'Which corner the heading sits in, inside the leg label box' },
  ...
  commCalloutAngleDeg: { value: -230, min: -359, max: 359, step: 5, label: 'Freq callout angle from track (°, +left)' },
  cumKiteAngleDeg: { value: 180, min: 0, max: 359, step: 5, label: 'Cumulative-time box angle from the leg box (°)' },
  cumKiteFillColor: { value: '#00ff00', type: 'color', label: 'Cumulative-time box fill color' },
  returnCumKiteFillColor: { value: '#ffccd6', type: 'color', label: 'Return-leg cumulative-time box fill color' },
  cumKiteHeightPx: { value: 23, min: 8, max: 100, step: 1, label: 'Cumulative-time box height (px)' },
  cumKiteCellWidthPx: { value: 43, min: 10, max: 120, step: 1, label: 'Cumulative-time box column width (px)' },
  cumKiteTriangleLenPx: { value: 20, min: 6, max: 100, step: 1, label: 'Cumulative-time box pointer length (px)' },
  ...
  cumKitePrintHeightMm: { value: 9.5, min: 1, max: 80, step: 0.5, label: 'Cumulative-time box height on paper (mm)' },
  cumKiteBorderPx: { value: 1.5, min: 0.25, max: 8, step: 0.25, label: 'Cumulative-time box border width (px)' },
  cumKiteTextPx: { value: 15, min: 4, max: 36, step: 1, label: 'Cumulative-time box text size (px)' },

  minuteMarkerFontPx: { value: 10, min: 4, max: 28, step: 1, label: 'Minute label text size (px)' },
  minuteTickEvenPx: { value: 9, min: 1, max: 30, step: 1, label: 'Even minute tick length (px)' },
  minuteTickOddPx: { value: 4, min: 1, max: 30, step: 1, label: 'Odd minute tick length (px)' },
  minuteTickEvenWidthPx: { value: 2, min: 0.25, max: 8, step: 0.25, label: 'Even minute tick width (px)' },
  minuteTickOddWidthPx: { value: 1.5, min: 0.25, max: 8, step: 0.25, label: 'Odd minute tick width (px)' },
  minuteLabelOffsetPx: { value: 8, min: 0, max: 40, step: 1, label: 'Minute label distance from the track (px)' },

  distanceBadgeRadiusPx: { value: 15, min: 4, max: 50, step: 1, label: 'Distance badge radius (px)' },
  distanceBadgeBorderPx: { value: 2.5, min: 0.25, max: 10, step: 0.25, label: 'Distance badge border width (px)' },
  distanceBadgeFontPx: { value: 11, min: 4, max: 30, step: 1, label: 'Distance badge text size (px)' },
  distanceBadgeFillColor: { value: '#fff6aa', type: 'color', label: 'Distance badge fill color' },

  waypointBaseRadiusPx: { value: 13, min: 2, max: 60, step: 1, label: 'Waypoint dot radius before the size selector (px)' },
  ...
  waypointFontPx: { value: 13, min: 4, max: 40, step: 1, label: 'Waypoint text size (px)' },
  ...
  waypointSelectedRadiusAddPx: { value: 2, min: 0, max: 20, step: 0.5, label: 'Selected waypoint radius add (px)' },
  waypointStrokeWidthPx: { value: 1, min: 0.25, max: 10, step: 0.25, label: 'Waypoint stroke width (px)' },
  ...
  commChangeArrowWidthPx: { value: 4, min: 1, max: 28, step: 0.5, label: 'Comm-change arrow width (px)' },
  ...
  commChangeArrowHaloPx: { value: 0, min: 0, max: 24, step: 0.5, label: 'Comm-change arrow light halo (px)' },
  commChangeArrowHaloColor: { value: '#fff9d6', type: 'color', label: 'Comm-change arrow halo color' },
  commChangeArrowHaloAlpha: { value: 0.92, min: 0, max: 1, step: 0.05, label: 'Freq-change arrow halo opacity (0-1)' },
  commChangeSelectedColor: { value: '#ffcc33', type: 'color', label: 'Comm-change selected color' },
  commChangeSelectedAlpha: { value: 0.35, min: 0, max: 1, step: 0.05, label: 'Selected freq-change callout opacity (0-1)' },
  commChangeSelectedWidthAddPx: { value: 5, min: 0, max: 40, step: 0.5, label: 'Comm-change selected width add (px)' },
  commChangeArrowBoltPx: { value: 15, min: 0, max: 80, step: 1, label: 'Comm-change lightning amplitude (px)' },
  commChangeArrowBoltAngleDeg: { value: 30, min: -180, max: 180, step: 1, label: 'Freq-change lightning bolt rotation (°)' },
  ...
  commChangeNameFontPx: { value: 12, min: 4, max: 40, step: 1, label: 'Comm-change name text size (px)' },
  commChangeFreqFontPx: { value: 12, min: 4, max: 54, step: 1, label: 'Comm-change freq text size (px)' },
  ...
  commChangeTextHaloAlpha: { value: 0.6, min: 0, max: 1, step: 0.05, label: 'Freq-change text halo opacity (0-1)' },
  commChangeTextAlong: { value: 0.88, min: 0.1, max: 0.95, step: 0.01, label: 'Comm-change text along arrow' },
  commChangeTextGapPx: { value: 10, min: 0, max: 30, step: 1, label: 'Comm-change text gap (px)' },
  commChangeNameHaloWidthPx: { value: 0, min: 0, max: 12, step: 0.5, label: 'Comm-change name halo width (px)' },
  commChangeFreqHaloWidthPx: { value: 0, min: 0, max: 14, step: 0.5, label: 'Comm-change freq halo width (px)' },

  noteFontPx: { value: 12, min: 4, max: 40, step: 1, label: 'Note text size (px)' },
  notePadXPx: { value: 8, min: 0, max: 40, step: 1, label: 'Note horizontal padding (px)' },
  notePadYPx: { value: 6, min: 0, max: 40, step: 1, label: 'Note vertical padding (px)' },
  noteLineHeightPx: { value: 16, min: 6, max: 60, step: 1, label: 'Note line height (px)' },
  noteMinWidthPx: { value: 56, min: 1, max: 240, step: 1, label: 'Note min width (px)' },
  ...
  noteStrokeWidthPx: { value: 1.5, min: 0.25, max: 8, step: 0.25, label: 'Note stroke width (px)' },
  noteSelectedStrokeWidthPx: { value: 2.5, min: 0.25, max: 10, step: 0.25, label: 'Selected note stroke width (px)' },
  noteDefaultFillColor: { value: '#fff6aa', type: 'color', label: 'Default note fill color' },

  pageFrameLineWidthPx: { value: 2, min: 0.25, max: 10, step: 0.25, label: 'Page frame line width (px)' },
  pageFrameDashOnPx: { value: 8, min: 1, max: 60, step: 1, label: 'Page frame dash on (px)' },
  pageFrameDashOffPx: { value: 5, min: 0, max: 60, step: 1, label: 'Page frame dash gap (px)' },
  pageFrameScrimColor: { value: '#141212', type: 'color', label: 'Page frame scrim color' },
  pageFrameScrimAlpha: { value: 0.4, min: 0, max: 1, step: 0.05, label: 'Dimming outside the print page frame (0-1)' },
  pageFrameLocked: { value: true, type: 'bool', label: 'Lock page frame to viewport centre' },
  pageFrameHitPx: { value: 14, min: 1, max: 80, step: 1, label: 'Page frame drag band (px)' },
  a4x2CutLineWidthPx: { value: 3, min: 0.25, max: 10, step: 0.25, label: 'A4×2 cut line width (px)' },
  a4x2CutDashOnPx: { value: 14, min: 1, max: 60, step: 1, label: 'A4×2 cut dash on (px)' },
  a4x2CutDashOffPx: { value: 9, min: 0, max: 60, step: 1, label: 'A4×2 cut dash gap (px)' },
  a4x2CutLineColor: { value: '#ff3b30', type: 'color', label: 'A4×2 cut line color' },
  a4x2CutLineAlpha: { value: 0.9, min: 0, max: 1, step: 0.05, label: 'A4×2 cut line opacity (0-1)' },
  ...
  hitWaypointExtraPx: { value: 6, min: 0, max: 40, step: 1, label: 'Waypoint hit extra (px)' },
  hitLegPx: { value: 8, min: 1, max: 60, step: 1, label: 'Leg line hit width (px)' },
  ...
  hitLegLabelMinPx: { value: 18, min: 1, max: 80, step: 1, label: 'Leg label hit min (px)' },
  hitCumLabelMinPx: { value: 18, min: 1, max: 80, step: 1, label: 'Cumulative-time label touch target, smallest side (px)' },
  ...
  gpsBreadcrumbWidthPx: { value: 3, min: 1, max: 10, step: 0.5, label: 'GPS breadcrumb width (px)' },
  overlayLabelHaloColor: { value: '#ffffff', type: 'color', label: 'Overlay label halo color' },
  overlayLabelHaloAlpha: { value: 0.85, min: 0, max: 1, step: 0.05, label: 'Overlay label halo opacity (0-1)' },
  ...
  graphLegWidthPx:     { value: 10, min: 1, max: 20, step: 0.5, label: 'Graph leg line width (px)' },
  graphLegArrowPx:     { value: 40, min: 6, max: 80, step: 1, label: 'Graph leg arrowhead size (px)' },
  ...
  altPairFocusWidthPx: { value: 5, min: 0.5, max: 16, step: 0.5, label: 'Alt-pair focus line width (px)' },
  altPairFocusDashOnPx: { value: 10, min: 0, max: 40, step: 1, label: 'Alt-pair focus dash on (px)' },
  altPairFocusDashOffPx: { value: 8, min: 0, max: 40, step: 1, label: 'Alt-pair focus dash gap (px)' },
  altPairFocusDotRadiusPx: { value: 7, min: 1, max: 30, step: 0.5, label: 'Alt-pair focus endpoint radius (px)' },
  ...
  sigmetFillAlpha: { value: 0.16, min: 0, max: 1, step: 0.02, label: 'SIGMET area fill opacity (0-1)' },
  sigmetLineWidthPx: { value: 2, min: 0.25, max: 10, step: 0.25, label: 'SIGMET outline width (px)' },
  ...
  lsaHighlightWidthPx: { value: 4, min: 0.5, max: 12, step: 0.5, label: 'LSA bubble highlight width (px)' },
  notamColor: { value: '#c026d3', type: 'color', label: 'NOTAM area color' },
  notamFillAlpha: { value: 0.14, min: 0, max: 1, step: 0.02, label: 'NOTAM area fill opacity (0-1)' },
  ...
  afWindMinZoom: { value: 9, min: 4, max: 15, step: 1, label: 'Airfield wind barb min zoom' },
  ...
  liveHeadingDashPx: { value: 9, min: 1, max: 30, step: 1, label: 'Live heading dash length (px)' },
  liveHeadingDashGapPx: { value: 6, min: 0, max: 30, step: 1, label: 'Live heading dash gap (px)' },
  liveHeadingTickPx: { value: 7, min: 2, max: 20, step: 1, label: 'Live heading tick length (px)' },
  liveHeadingLabelPx: { value: 11, min: 7, max: 24, step: 1, label: 'Live heading label size (px)' },
  liveHeadingLabelGapPx: { value: 6, min: 0, max: 20, step: 1, label: 'Live heading label gap (px)' },
  ...
  gotoMarkerRadiusPx: { value: 7, min: 2, max: 24, step: 1, label: 'Go-to marker radius (px)' },
  gotoMarkerWeightPx: { value: 2, min: 0.5, max: 8, step: 0.5, label: 'Go-to marker stroke width (px)' },
  ...
  satellitePreviewWidthPx: { value: 214, min: 120, max: 480, step: 2, label: 'Satellite preview width (px)' },
  satellitePreviewHeightPx: { value: 118, min: 80, max: 360, step: 2, label: 'Satellite preview height (px)' },
  satelliteMarkerRadiusPx: { value: 7, min: 2, max: 24, step: 1, label: 'Satellite marker radius (px)' },
  satelliteMarkerColor: { value: '#ffda4c', type: 'color', label: 'Satellite marker color' },
  satelliteMarkerWeightPx: { value: 2, min: 0.5, max: 8, step: 0.5, label: 'Satellite marker stroke width (px)' },
  satelliteMarkerAlpha: { value: 0.96, min: 0, max: 1, step: 0.02, label: 'Satellite marker opacity' },
  profileAxisHeightPx: { value: 30, min: 12, max: 80, step: 1, label: 'Vertical profile axis height (px)' },
  profileYPadPx: { value: 34, min: 8, max: 80, step: 1, label: 'Vertical profile side padding (px)' },
  ...
  vorMarkerRadiusPx: { value: 9, min: 3, max: 30, step: 0.5, label: 'VOR marker radius (px)' },
  vorMarkerWidthPx: { value: 2, min: 0.25, max: 8, step: 0.25, label: 'VOR marker stroke width (px)' },
  ...
  floatingPanelGapPx: { value: 12, min: 0, max: 80, step: 1, label: 'Floating panel separation (px)' },
  zuluClockMinWidthPx: { value: 82, min: 40, max: 180, step: 1, label: 'Zulu clock min width (px)' },
  zuluClockPadYPx: { value: 5, min: 0, max: 24, step: 1, label: 'Zulu clock vertical padding (px)' },
  zuluClockPadXPx: { value: 8, min: 0, max: 36, step: 1, label: 'Zulu clock horizontal padding (px)' },
  zuluClockMarginTopPx: { value: 4, min: 0, max: 80, step: 1, label: 'Zulu clock top margin (px)' },
  zuluClockMarginRightPx: { value: 12, min: 0, max: 80, step: 1, label: 'Zulu clock right margin (px)' },
  zuluClockFontPx: { value: 13, min: 8, max: 28, step: 1, label: 'Zulu clock text size (px)' },
  ...
  zuluClockBgAlpha: { value: 0.88, min: 0, max: 1, step: 0.05, label: 'Zulu clock background opacity (0-1)' },
  zuluClockBorderColor: { value: '#3a3636', type: 'color', label: 'Zulu clock border color' },
  zuluClockBorderWidthPx: { value: 1, min: 0, max: 8, step: 0.25, label: 'Zulu clock border width (px)' },
  zuluClockBorderRadiusPx: { value: 5, min: 0, max: 24, step: 1, label: 'Zulu clock border radius (px)' },
  zuluClockShadowYPx: { value: 2, min: 0, max: 18, step: 1, label: 'Zulu clock shadow y (px)' },
  zuluClockShadowBlurPx: { value: 8, min: 0, max: 36, step: 1, label: 'Zulu clock shadow blur (px)' },
  zuluClockShadowAlpha: { value: 0.45, min: 0, max: 1, step: 0.05, label: 'Zulu clock shadow opacity (0-1)' },
  ...
  kiteNoteAlpha: { value: 0.5, min: 0, max: 1, step: 0.05, label: 'Leg label box and note fill opacity (0-1)' },
  ...
  followMePlaneColor: { value: '#182839', type: 'color',
    label: 'Follow me: follower aircraft color' },
  ...
  // Pressing "add to route" on a field, a reporting point or a coordinate used to swap that
  // small reference panel for the full route-waypoint inspector -- delete, rename, turning
  // point, the clock -- over the map the pilot had just put a point on. The panel closes
  // instead. Off puts the old behaviour back, for anyone who was using it to go straight into
  // naming the point they just added.
  addToRouteClosesInspector: { value: true, type: 'bool',
    label: 'Adding to the route closes the inspector' },
...
window.S = Object.assign({
  ...
  routeCheckNothing: 'nothing',
  routeCheckNotRead: 'could not be read',
  routeCheckFound: (n) => n + ' found',
  ...
  routeLibraryGroupTracks: 'Recordings',
  routeLibraryShowLabel: 'Show',
  routeLibraryShowAll: 'Everything',
  routeLibraryNoRoutes: 'No saved routes yet.',
  routeLibraryNoTracks: 'No recordings yet.',
  ...
  trackProfileCompareWith: 'Compare with',
  trackProfileCompareNone: '— nothing —',
  trackProfileCompareMap: 'the route on the map',
  ...
  routeLibraryGdriveSyncPii: 'Also uploads your pilot details (name, licence, phone, email) and aircraft profile to Drive. The AIS filing address and AI keys never leave this device.',
  ...
  notamSortLabel: 'Sort NOTAMs',
  notamSortRelevance: 'Relevance',
  notamSortNumber: 'NOTAM number',
  notamSortStart: 'Start time',
  notamSortEnd: 'End time',
  ...
  airmetModalTitle: 'Active AIRMETs',
  airmetValid: 'Valid',
  airmetRaw: 'Raw',
  tbAirmet: '⚠ AIRMET',
  tbAirmetTitle: 'Read the decoded text and validity of each active AIRMET (IMS, Tel Aviv FIR)',
  sigmetRaw: 'Raw',
  tbWindDir: 'Wind °',
  ...
  navLogHeaderTitles: ['Leg', 'From', 'To', 'Calibrated airspeed', 'Pressure altitude',
    'Outside air temperature', 'True airspeed', 'Wind speed', 'Wind direction', 'True track',
    'Drift angle', 'True heading', 'Magnetic variation', 'Magnetic heading', 'Compass deviation',
    'Compass heading', 'Ground speed', 'Distance', 'Time for this leg', 'Time from departure',
    'Fuel flow', 'Fuel for this leg', 'Fuel from departure'],
  ...
  fplParkingAsk: 'Please confirm the assigned stand and any restrictions.',
  fplParkingTo: 'To',
  fplParkingNoAddress: 'no published address — you will need to fill it in',
  fplParkingKind: 'Parking',
  ...
  fplParkingFMobile: 'Mobile',
  fplParkingFPob: 'Persons on board',
  fplParkingFFrom: 'From',
  fplParkingFTo: 'To',
  fplParkingFDof: 'Date of flight',
  fplParkingFDep: 'departure',
  fplParkingFHandling: 'Handling',
  fplAttribution: 'Created using NavAid',
  fplFeedback: 'comments and feedback:',
  fplNext: 'Continue',
  fplBack: 'Back',
  ...
  deckHereTitle: 'What is here',
  deckHereCoords: 'Position',
  deckHereNearest: 'Nearest field',
  deckHereTerrain: 'Highest terrain',
  deckHereNow: 'NOW',
  ...
  rotateHeadingLabel: 'Map heading (degrees)',
  rotateDialLabel: 'Map rotation dial (degrees) — arrows turn the map, Home for north up',
  ...
  followLockOn: 'Following your aircraft — tap to stop following',
  followLockOff: 'Not following — tap to follow your aircraft',
  ...
  tbPlateEnabled: 'Show airfield charts',
  tbPlateEnabledTitle: 'Show the selected airfield chart overlay',
  tbPlateType: 'Which chart',
  tbPlateTypeTitle: 'Choose which airfield chart to show; these charts are mutually exclusive',
  plateTypeCircuit: 'Circuit patterns',
  plateTypeTraining: 'Training areas',
  ...
  followMeAskTitle: 'Follow me',
  followMeAskLabel: 'Identifier',
  followMeAskShare: 'Share',
  ...
  tbInspectorTracking: 'Panel while showing position',
  tbInspectorTrackingTitle: 'Let a tap open the inspector while your position is on the map. Off by default: in flight the chart is what you are reading.',
  inspectorTrackingBlocked: 'The panel stays shut while your position is showing — turn it on in View/Set.',
  ...
  tbIfrOpacity: 'Chart opacity',
  tbIfrOpacityTitle: 'Adjust the instrument-chart overlay opacity',
  tbIfrOpacityReset: 'Reset instrument-chart opacity',
  tbIfrSheetTitle: 'Which instrument chart to draw. One at a time, with the last selection remembered.',
  ...
  printFitNoRoute: 'Draw a route first — there is nothing to fit a page to yet.',
  printFitAlready: 'The route already fits this page.',
  printFitTitle: 'Pick the smallest page that holds the route and centre it there.',
  tbPrint: '🖨 Print',
...
function decodeTaf(t) {
  ...
  return fc.map(f => {
    ...
    // Expand the change indicators rather than leaving the raw codes in the plain-language
...
// a-b-a-b is the same two legs again on top of the two already drawn, and nothing on the
...
function trackPassCount(wps, a, b) {
  ...
  for (let i = 0; i < wps.length - 1; i++) {
    ...
    if ((same(p, a) && same(q, b)) || (same(p, b) && same(q, a))) n++;
  }
  return n;
}
...
function routeAllowsNextPoint(next, wps) {
  ...
  if (!next || list.length < 1) return true;
  return !routeOverflownTrack(list.concat([next]));
}
if (typeof window !== 'undefined') window.routeAllowsNextPoint = routeAllowsNextPoint;
...
function routeCheckFindings(input) {
  ...
  // --- ceiling ---------------------------------------------------------------------------
  // CVFR requires clearance below BKN/OVC, not merely a planned altitude below the base.
    ...
    for (const st of o.wx) {
      ...
      for (const set of sets) {
        for (let i = 0; i < legs.length; i++) {
          ...
          for (const layer of routeCheckLayersBelow(set.clouds, altitude, st.elevationFt)) {
