...
window.S = Object.assign({
  ...
  altPairsPair: 'Pair',
  altPairsDirection: 'Direction',
  altPairsAltitude: 'Altitude',
  altPairsInbound: 'Forward',
  altPairsOutbound: 'Reverse',
  altPairsInboundTitle: 'Altitude for the first shown direction in this row',
  altPairsOutboundTitle: 'Altitude for the reverse shown direction in this row',
  altPairsStatus: 'Type',
  altPairsDistance: 'NM',
