...
window.S = Object.assign({
  ...
  offlineCvfrProgress: function(p) { return 'Offline CVFR: ' + p + '%'; },
  offlineCvfrWaiting: function(p) { return 'Offline CVFR: ' + p + '% — waiting for connection'; },
  offlineCvfrDetail: function(present, total, p) { return present + ' of ' + total + ' tiles · ' + p + '%'; },
  offlineCvfrRepair: 'Repair missing tiles',
