...
window.S = Object.assign({
  ...
  tbSimIpTitle: 'URL of the SimConnect bridge. HTTP works for desktop loopback or when the NavAid page is also HTTP; otherwise use HTTPS.',
  ...
  tbSimHelpNative: 'Native app: this build loads the HTTPS web app. Use an HTTPS bridge; local HTTP requires native local-network support.',
  ...
  tbSimNativeHttp: '⚠ This native build cannot use a local HTTP bridge yet. Enter an HTTPS bridge or tunnel URL.',
