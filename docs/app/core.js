...
window.S = Object.assign({
  ...
  // Nav-log (printed plan) column headers — a fixed kneeboard set.
  navLogColDest: 'Destination',
  navLogColDir: 'Direction',
  navLogColAlt: 'Altitude',
  navLogColSpeed: 'Speed',
  navLogColLegTime: 'Time of leg',
  navLogColLegFuel: 'Fuel of leg',
  navLogColComm: 'Comm freq',
  fpFuel: 'Fuel',
  fpMsa: 'MSA (ft)',
