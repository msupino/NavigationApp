...
NavAid.tuningDefaults = {
  ...
  searchMaxBubbles: { value: 3, min: 0, max: 20, step: 1, label: 'Search: max LSA bubbles' },
...
window.S = Object.assign({
  ...
  bubbleSecondaryNote: 'Unverified',
  bubbleWeekdayHint: 'A secondary source lists weekday opening from',
