...
window.S = Object.assign({
  ...
  navTableFetchMetTitle: 'Wind and temperature for every level this flight touches, at the middle of the route',
  navTableFetchMetErr: 'Could not fetch the forecast.',
  navTableMetFetched: (n) => n + ' levels fetched into the met table.',
