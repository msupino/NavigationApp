...
window.S = Object.assign({
  ...
  exportLayer: 'Layer',
  exportBtn: 'Export',
  exportWysiwygSubtitle: 'Click inside the preview to place the table, then drag the box to move it.',
  exportWysiwygNoFrameHint: 'Choose A3 or A4 (page frame) to enable placement.',
  exportWysiwygRemove: '✕ Clear placement',
  exportWysiwygRemoveTitle: 'Remove the flight plan table from the print layout',
  ...
  planPlacementLabel: 'Flight plan table on print',
  planPlacementNone: 'None',
  planPlacementTL: '↖ TL',
  planPlacementTR: '↗ TR',
  planPlacementBL: '↙ BL',
  planPlacementBR: '↘ BR',
  planPlacementCustom: 'Custom…',
}, window.S || {});
