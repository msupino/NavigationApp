...
window.S = {
  ...
  fpHeaders: ['#', 'מ-', 'אל-', 'כיוון', 'מרחק (NM)', 'מהירות (קשר)', 'גובה (ft)', 'זמן', 'דלק (גאל)', 'נותר'],
  fpTotal: 'סה"כ',
  fpReturn: 'מסלול חזרה',
  fpClose: 'סגור',
  fpPrint: 'הדפס',
  fpFuel: 'דלק',
  fpRemaining: 'נותר',
  fpFuelWarn: function(h) { return '⚠ סה"כ ' + h.toFixed(1) + ' גאל חורג מקיבולת המכל פחות הרזרבה'; },
  tbAircraft: 'כלי טיס',
  tbAircraftTitle: 'בחר כלי טיס לחישוב דלק',
  tbCustom: 'מותאם אישית',
  tbGph: 'גל"ש',
  tbGphTitle: 'צריכת דלק, גלונים לשעה',
  tbTank: 'מכל (גאל)',
  tbTankTitle: 'קיבולת מכל דלק כוללת',
  tbReserve: 'רזרבה (דק)',
  tbReserveTitle: 'רזרבת דלק חובה בדקות',
