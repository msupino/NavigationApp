...
window.S = {
  ...
  tbResetAllWpNamesTitle: 'איפוס כל שמות ציוני הדרך לקודי הייחוס או ל-WP{N}',
  resetAllWpNamesConfirm: 'לאפס את כל שמות ציוני הדרך לקודי ייחוס (או ל-WP{N} כשאין נקודת ייחוס סמוכה)?',
