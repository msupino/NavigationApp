...
window.S = {
  ...
  proposedAltitudesUrl: 'proposed-altitudes.json?v=1',
  ...
  tbAltPairs: '🧭 זוגות גובה',
  tbAltPairsTitle: 'הצג והעתק זוגות גובה CVFR שנלמדו',
  ...
  freqTableOverride: 'דריסה',
  freqTableRestoreAll: 'שחזר מקוריים',
  freqTableEmpty: 'אין קטלוג תדרים זמין',
  freqTableSearch: 'חיפוש תדרים',
  freqTableNoMatches: 'אין תדרים תואמים',
  altPairsTitle: 'זוגות גובה CVFR',
  altPairsCopyJson: 'העתק JSON',
  altPairsCopied: 'הועתק',
  altPairsCopyFailed: 'העתקה נכשלה',
  altPairsEmpty: 'אין נתוני זוגות גובה זמינים',
  altPairsSearch: 'חפש זוגות גובה',
  altPairsNoMatches: 'אין זוגות גובה תואמים',
  altPairsPair: 'זוג',
  ...
  resetFreqOverride: 'אפס תדר לברירת המחדל',
  plates: 'דפיות',
  runways: 'מסלולים',
