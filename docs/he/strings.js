...
window.S = {
  ...
  exportBtn: 'ייצא',
  exportWysiwygSubtitle: 'לחץ בתוך התצוגה המקדימה כדי למקם את הטבלה, ואז גרור את התיבה למיקום הרצוי.',
  exportWysiwygNoFrameHint: 'בחר A3 או A4 (מסגרת דף) כדי לאפשר מיקום.',
  exportWysiwygRemove: '✕ נקה מיקום',
  exportWysiwygRemoveTitle: 'הסר את טבלת תכנית הטיסה מתוך פריסת ההדפסה',
  addPlanToMap: 'הוסף מסלול למפה',
  addPlanToMapTitle: 'מיקום מציין-מקום הניתן לגרירה ולשינוי גודל על המפה; טבלת תכנית הטיסה תצויר לתוכו בייצוא.',
  removePlanFromMap: 'הסר את מציין-המקום',
  planPlaceholderLabel: 'מסלול',
  planPlacementLabel: 'טבלת תכנית הטיסה בהדפסה',
  planPlacementNone: 'ללא',
  planPlacementTL: '↖ ש"ע',
  planPlacementTR: '↗ י"ע',
  planPlacementBL: '↙ ש"ת',
  planPlacementBR: '↘ י"ת',
