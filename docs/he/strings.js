...
window.S = {
  ...
  tbShowReporting: 'הצג סוג דיווח',
  tbShowReportingTitle: 'סמן ב־M ציוני דיווח חובה (סוג דיווח בתרשים: חובה)',
  reportingMandatory: '📍 דיווח חובה',
  reportingOnRequest: '📍 דיווח לפי דרישה',
  reportingArp: '📍 שדה תעופה (ARP)',
  errInvalidReporting: function(msg) { return 'נתוני סוג דיווח לא תקינים: ' + msg; },
  plates: 'דפיות',
  runways: 'מסלולים',
